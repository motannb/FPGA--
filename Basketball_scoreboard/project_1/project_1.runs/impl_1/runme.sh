...
HD_PWD='D:/NI/Basketball_scoreboard/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basketball_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basketball_top.tcl -notrace
