...
HD_PWD='D:/NI/Basketball_scoreboard/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basketball_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basketball_top.tcl
